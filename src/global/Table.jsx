...
// //                         {showSerialNo && (
// //                             <th
// //                                 className="px-4 py-3 text-left font-semibold text-heading border-r border-border"
// //                                 style={{
// //                                     width: "70px",
// //                                     fontFamily: "var(--font-heading)",
// //                                 }}
...
// //                             className={`border-b border-border last:border-b-0 transition-colors ${onRowClick ? "cursor-pointer hover:bg-background" : ""
// //                                 }`}
// //                         >
// //                             {showSerialNo && (
// //                                 <td
// //                                     className="px-4 py-3 border-r border-border text-text"
...
//             >
//                 <colgroup>
//                     {showSerialNo && <col style={{ width: "70px" }} />}
//                     {columns.map((col) => (
//                         <col
//                             key={col.key}
//                             style={{ width: col.width || "auto" }}
...
export default function Table({
    ...
    return (
        <div className="w-full border border-border rounded-sm">
            <table
                className="w-full table-fixed text-sm border-collapse"
