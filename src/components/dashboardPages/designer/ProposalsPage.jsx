...
// PDFs (and HEIC, which browsers can't render inline) are excluded here —
// they still show up inside the modal's Attachments section as file/link cards.
...
export default function ProposalsPage() {
  ...
  const { data, isLoading, isFetching, isError, refetch } = useGetDesignerProjectsQuery({
