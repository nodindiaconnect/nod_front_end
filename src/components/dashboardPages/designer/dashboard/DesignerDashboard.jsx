...
export default function DesignerDashboard() {
  ...
  const projectCards = [
    ...
    { icon: CheckCircle2, label: "Completed Projects", value: ps.completedProjects ?? 0, color: C.success },
  ]
      ...
      >
        ...
        <div className="px-5 sm:px-6 py-5">
          ...
          <div className="mt-6">
              ...
              <div className="flex gap-1.5">
                {["", "PENDING", "ACCEPTED", "REJECTED"].map((s) => (
                  <button
                    ...
                    className="text-[10px] px-2.5 py-1.5 rounded-md font-semibold uppercase tracking-wide"
                    style={{
            ...
            {quotationsLoading ? (
              <div className="text-center py-12 text-sm border rounded-md" style={{ color: C.muted, borderColor: C.border, fontFamily: "var(--font-body)" }}>
                Loading…
              </div>
            ) : (
              <Table
