...
} from "./dashboard/contractorApiSlice";
import "../../../theme.css";
...
const BriefcaseIcon = (props) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M20.25 14.15v4.1a2 2 0 01-2 2H5.75a2 2 0 01-2-2v-4.1M20.25 14.15a2 2 0 00-.998-1.73L18 11.5m2.25 2.65L14.4 10.5m-9.65 3.65a2 2 0 00.998-1.73L7 11.5m-2.25 2.65L9.6 10.5M9 8V6.75A1.75 1.75 0 0110.75 5h2.5A1.75 1.75 0 0115 6.75V8m-6 0h6m-6 0H3.75v3.5L12 15.5l8.25-4V8H15"
    />
  </svg>
);
...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    const hydratedForm = {
      ...
      workTypes: data.workTypes || data.specializations || [],
      specializations: data.specializations || data.workTypes || [],
  ...
  const validate = () => {
    ...
    if (!form.workTypes.length && !form.specializations.length)
      return "Add at least one contracting service / work type.";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        workTypes: form.workTypes.length
          ? form.workTypes
          : form.specializations,
        specializations: form.workTypes.length
          ? form.workTypes
          : form.specializations,
      ...
      >
        <div className="min-h-0 w-full flex-1 overflow-y-auto">
          <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-4 py-6 sm:px-6 lg:px-8">
                ...
                <div className="flex min-w-0 items-center gap-4">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="mt-0.5 truncate text-xs text-[var(--muted)] sm:text-sm">
                      Complete your profile details to get discovered by more
                      clients.
                    </p>
                  </div>
                </div>
            ...
            <div className={cardClass}>
              <SectionHeader
                icon={<BriefcaseIcon className="h-4.5 w-4.5" />}
            ...
            <div className={cardClass}>
              <SectionHeader
                ...
                title="Work Types & Business Info"
              />

              <div className="grid w-full grid-cols-1 gap-5">
                {renderMultiSelectField(
                  "workTypes",
                  "Contracting Services & Work Types",
                  WORK_TYPE_OPTIONS,
                  true,
                )}
              </div>
