...
//   return (
//     <div className="profile-page flex h-full w-full flex-col overflow-hidden">
//       <form
...
//           <div className="profile-page__header flex w-full flex-wrap items-center justify-between gap-4 px-5 py-6 sm:px-8">
...
//                 )}
//                 {isEditing && (
//                   <label className="absolute inset-0 flex cursor-pointer items-center justify-center rounded-full bg-[var(--heading)]/0 text-[var(--background)] opacity-0 transition group-hover:bg-[var(--heading)]/70 group-hover:opacity-100">
//                     {avatarUploading ? (
...
//           {/* BODY */}
//           <div className="profile-page__content profile-page__body w-full px-5 pt-6 sm:px-8">
//             <div className="flex w-full flex-col">
//               {/* BASIC INFORMATION */}
//               <section className="profile-page__section w-full">
      ...
      >
        <div className="min-h-0 w-full flex-1 overflow-y-auto">
          <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-4 py-6 sm:px-6 lg:px-8">
            ...
            {/* ---------------------------------------------------------- */}
            <div className={cardClass}>
              <SectionHeader icon={<StarIcon className="h-4.5 w-4.5" />} title="Specialties" />
