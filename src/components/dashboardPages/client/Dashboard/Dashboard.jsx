    ...
    <div className="min-h-screen" style={{ background: C.background }}>
      ...
      >
        ...
        <div className="px-4 sm:px-5 py-5">
          ...
          {/* Projects table */}
          <div className="mt-6">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-3.5">
              {/* Heading */}
              ...
              <div className="flex flex-wrap gap-2 lg:justify-end">
                {[
                  ...
                  <button
                    ...
                    className="text-[10px] sm:text-[11px] px-3 py-1.5 rounded-sm font-semibold uppercase tracking-wide whitespace-nowrap"
                    style={{
                      background:
                        statusFilter === s ? C.primary : C.backgroundSecondary,
                      color: statusFilter === s ? C.surface : C.muted,
                      fontFamily: "var(--font-body)",
                    }}
                  >
