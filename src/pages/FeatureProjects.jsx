...
export default function FeaturedProjects() {
  ...
  // Regular grid cards — kept to a clear, medium-small, uniform size.
  const projects = [
    {
      image: commercialImg,
      title: "Royal Heritage Reception Lounge",
  ...
  // Last project is shown separately as a full-width banner card.
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {/* GRID — uniform, clearly sized cards */}
        ...
        <div className="mt-6">
          {renderCard(featuredProject, projects.length)}
        </div>
      </div>
    </section>
  );
